...
An extremely weird fork of content from Nocrypt's notebook by a DID system that has no clue how to code. We'd call it opinionated, but it's not a WebUI, so apart from ElFinder, free users should be able to use this.
...
## CHANGES TO COLAB
  ...
  Not much just cleaned up some stuff.
-----------------
## ***Forked from - EVERYDREAM2 TRAINER - LYNN - AND NOCRYPT ***
...
WIP: May see if we can patch the otehr version from jupyter as an extension in here later on.
